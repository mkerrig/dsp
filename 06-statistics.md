...
Probability of a fraternal twin is 12/1500, whereas identical is 4/1500, so therefore identical twins make up 25% (4/16) of all twins whereas fraternal twins makeup 75% of the twin population. I take notice to the fact that it was said Elvis had a twin brother, meaning being male I believe is part of the problem. So provided that I know nothing about Elvis’s genes, nor the chances of being the same sex or different sexes in fraternal twins, I’m going to go ahead and assume that it’s a 50/50 chance of having the same sex fraternal twin. Given this information we can define all our variables:

E = Elvis had a twin brother
...
So there was a 40% chance (assuming it’s a 50/50 for a brother or sister in the case of a fraternal twin) that Elvis was an identical twin
